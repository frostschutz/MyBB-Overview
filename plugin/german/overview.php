...
function overview_info()
{
	return array(
		"name"        => "&Uuml;bersicht",
		"title"        => "&Uuml;bersicht",
		"description" => "F&uuml;gt eine &Uuml;bersichtsbox auf der Startseite ein, die verschiedene Informationen zum Forum bereitstellt.",
		"website"     => "http://www.mybboard.de",
		"author"      => "MyBBoard.de",
...
function overview_activate()
{
	...
	$templatearray = array(
        ...
        <!-- Der Backlink darf nicht gelöscht werden! Lesen Sie die Readme für weitere Details. -->
	...
	$overview_group = array(
		...
		"name" => "&Uuml;bersicht",
		"title" => "&Uuml;bersicht",
		"description" => "Einstellungen f&uuml;r das Plugin \"&Uuml;bersicht\"",
		"disporder" => "1",
		"isdefault" => "no",
		);
	...
	$overview_2 = array(
		...
		"title" => "Zeige neueste Mitglieder?",
		"description" => "Sollen die neuesten Benutzer gezeigt werden?",
		"optionscode" => "yesno",
		"value" => "yes",
		"disporder" => "2",
		"gid" => intval($gid),
	...
	$overview_3 = array(
		...
		"title" => "Reihenfolge",
		"description" => "Geben Sie die Anzeigereihenfolge ein.",
		"optionscode" => "text",
		"value" => "1",
		"disporder" => "3",
		"gid" => intval($gid),
	...
	$overview_4 = array(
		...
		"title" => "Zeige Top Poster?",
		"description" => "Sollen die Benutzer mit den meisten Beitr&auml;gen gezeigt werden?",
		"optionscode" => "yesno",
		"value" => "no",
		"disporder" => "4",
		"gid" => intval($gid),
	...
	$overview_6 = array(
		...
		"title" => "Zeige neueste Themen?",
		"description" => "Sollen die neuesten Themen gezeigt werden?",
		"optionscode" => "yesno",
		"value" => "yes",
		"disporder" => "6",
		"gid" => intval($gid),
	...
	$overview_8 = array(
		...
		"title" => "Zeige Themen mit meisten Antworten?",
		"description" => "Sollen die Themen mit den meisten Antworten gezeigt werden?",
		"optionscode" => "yesno",
		"value" => "no",
		"disporder" => "8",
		"gid" => intval($gid),
	...
	$overview_10 = array(
		...
		"title" => "Zeige beliebteste Themen?",
		"description" => "Sollen die beliebtesten Themen gezeigt werden?",
		"optionscode" => "yesno",
		"value" => "no",
		"disporder" => "10",
		"gid" => intval($gid),
	...
	$overview_12 = array(
		...
		"title" => "Zeige neueste Beitr&auml;ge?",
		"description" => "Sollen die neuesten Beitr&auml;ge gezeigt werden?",
		"optionscode" => "yesno",
		"value" => "yes",
		"disporder" => "12",
		"gid" => intval($gid),
	...
	$overview_14 = array(
		...
		"title" => "Zeige \"RE:\" vor dem Betreff von Antworten?",
		"description" => "Soll \"RE:\" vor dem Betreff einer Antwort zu einem Thema gezeigt werden?",
		"optionscode" => "yesno",
		"value" => "yes",
		"disporder" => "14",
		"gid" => intval($gid),
	...
	$overview_15 = array(
		...
		"title" => "Anzahl der zu zeigenden Zeichen",
		"description" => "Wie viele Zeichen des Themas/Betreffs sollen ausgegeben werden (0 = alle zeigen)?",
		"optionscode" => "text",
		"value" => "0",
		"disporder" => "15",
		"gid" => intval($gid),
	...
	$overview_16 = array(
		...
		"title" => "Benutzernamen fomatieren?",
		"description" => "Sollen Benutzernamen im Stil der Benutzergruppe angezeigt werden?<br />Hinweis: Kann sehr viele Datenbankabfragen ben&ouml;tigen.",
		"optionscode" => "yesno",
		"value" => "no",
		"disporder" => "16",
		"gid" => intval($gid),
	...
	$overview_17 = array(
		...
		"title" => "Nachricht ein-/ausschalten",
		"description" => "Soll eine Nachricht angezeigt werden?",
		"optionscode" => "yesno",
		"value" => "no",
		"disporder" => "17",
		"gid" => intval($gid),
	...
	$overview_18 = array(
		...
		"title" => "Nachricht",
		"description" => "Die Nachricht, die angezeigt werden soll.",
		"optionscode" => "textarea",
		"value" => "Hier die Nachricht eingeben!",
		"disporder" => "18",
		"gid" => intval($gid),
		);
	...
	$overview_19 = array(
		...
		"title" => "Ajax",
		"description" => "Wollen Sie Ajax aktivieren, damit sich die &Uuml;bersicht selbst neu l&auml;dt?",
		"optionscode" => "yesno",
		"value" => "no",
		"disporder" => "19",
		"gid" => intval($gid),
	...
	$overview_20 = array(
		...
		"title" => "Intervall",
		"description" => "In welchem Zeitabstand in Sekunden soll sich die &Uuml;bersicht neu laden?",
		"optionscode" => "text",
		"value" => "60",
		"disporder" => "20",
		"gid" => intval($gid),
	...
	$overview_21 = array(
		...
		"title" => "Ladeanzeige",
		"description" => "Soll eine Ladeanzeige angezeigt werden?",
		"optionscode" => "yesno",
		"value" => "yes",
		"disporder" => "21",
		"gid" => intval($gid),
	...
	$overview_22 = array(
		...
		"title" => "Nur f&uuml;r Mitglieder?",
		"description" => "Soll die &Uuml;bersicht f&uuml;r G&auml;ste ausgeblendet werden?",
		"optionscode" => "yesno",
		"value" => "no",
		"disporder" => "22",
		"gid" => intval($gid),
	...
	$overview_23 = array(
		...
		"title" => "htmlentities() oder htmlspecialchars()?",
		"description" => "Soll htmlentities() oder htmlspecialchars() benutzt werden?<br /><small>Wenn es Probleme mit der Darstellung von Spezialzeichen gibt, bitte die andere Methode w&auml;hlen</small>",
		"optionscode" => "radio
        1=htmlentites
        2=htmlspecialchars",
		"value" => "1",
